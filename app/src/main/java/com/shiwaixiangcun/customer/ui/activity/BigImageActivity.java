...
public class BigImageActivity extends AppCompatActivity implements View.OnClickListener ,ViewPager.OnPageChangeListener{
...
//    private ImageView[] mImageViews = new ImageView[mImgs.length];
    private List<RecoratingDetailBean.DataBean.CertificatesBean> mylist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylist = (List<RecoratingDetailBean.DataBean.CertificatesBean>) intent.getSerializableExtra("bigimagelist");
