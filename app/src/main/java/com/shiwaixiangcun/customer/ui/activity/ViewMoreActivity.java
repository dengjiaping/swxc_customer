...
//        oks.setImagePath(shareimage);//确保SDcard下面存在此张图片
        ...
        oks.setCallback(new PlatformActionListener() {
            ...
            public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                ...
                Toast.makeText(ViewMoreActivity.this,"分享成功",Toast.LENGTH_LONG).show();
            }
            ...
            public void onError(Platform platform, int i, Throwable throwable) {
                ...
                Toast.makeText(ViewMoreActivity.this,"分享失败",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onCancel(Platform platform, int i) {
                Log.e("rrrrrrrrr","onCancel");
                Toast.makeText(ViewMoreActivity.this,"取消",Toast.LENGTH_LONG).show();
            }
        });
