...
import com.shiwaixiangcun.customer.presenter.IWeightPresenter;
...
public class WeightImpl implements IWeightPresenter {
    private IWeightView iWeightView;
    private String str_content;

    public WeightImpl(IWeightView iWeightView, String str_content) {
        this.iWeightView = iWeightView;
        ...
        HttpRequest.get(Common.bmiList, hashMap, new HttpCallBack() {
            ...
            public void onSuccess(String responseJson) {
                ...
                if (responseEntity.getResponseCode() == 1001) {
                    iWeightView.setBgaAdpaterAndClickResult(responseEntity);
