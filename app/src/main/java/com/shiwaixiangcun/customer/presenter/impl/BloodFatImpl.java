...
import com.shiwaixiangcun.customer.presenter.IBloodFatPresenter;
...
public class BloodFatImpl implements IBloodFatPresenter {
    private IBloodFatView iBloodFatView;
    private String str_content;

    public BloodFatImpl(IBloodFatView iBloodFatView, String str_content) {
        this.iBloodFatView = iBloodFatView;
...
//                ResponseEntity<PageBean<BloodFatBean>> responseEntity = JsonUtil.fromJson(responseJson, type);
                ...
                if (pressureFatBean.getResponseCode() == 1001) {
                    iBloodFatView.setBgaAdpaterAndClickResult(pressureFatBean);
