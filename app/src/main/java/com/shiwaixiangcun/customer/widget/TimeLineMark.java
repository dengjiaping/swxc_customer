...
public class TimeLineMark extends View {
    ...
    public TimeLineMark(Context context) {
        this(context, null);
    }

    public TimeLineMark(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TimeLineMark(Context context, AttributeSet attrs, int defStyle) {
