...
public class ImageDetailAdapter extends BaseAdapter {
    private List<RecoratingDetailBean.DataBean.DecoratePlanDtosBean.DesignChartsBean> list;
    private Context context;

    public ImageDetailAdapter(List<RecoratingDetailBean.DataBean.DecoratePlanDtosBean.DesignChartsBean> list, Context context) {
        this.list = list;
