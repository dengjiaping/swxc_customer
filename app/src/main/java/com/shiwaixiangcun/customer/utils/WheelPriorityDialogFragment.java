 ...
 */
public class WheelPriorityDialogFragment extends DialogFragment implements WheelView.OnValueChangeListener {
     ...
     * @return
     */
    public static WheelPriorityDialogFragment newInstance(String[] wheel, String left, String right,
                                                          boolean isBack, boolean isCancelable, boolean isCancelableTouchOutSide) {
        WheelPriorityDialogFragment wheelDialog = new WheelPriorityDialogFragment();
     ...
     * @return
     */
    public static WheelPriorityDialogFragment newInstance(String[] wheel) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.view_priority_dialog_wheel, null);
    ...
    private void initEvent() {
        ...
        ll_sex.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onWheelDialogListener != null) {
                    onWheelDialogListener.onAllcenter(getWheelValue());
                }
