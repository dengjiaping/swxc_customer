...
public class AppSharePreferenceMgr {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "shiwaixiangcun";
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        String imgString = android.util.Base64.encodeToString(byteArray, android.util.Base64.DEFAULT);
        // 将String保存shareUtils
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        ...
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
            byte[] byteArray = android.util.Base64.decode(imgString, android.util.Base64.DEFAULT);
