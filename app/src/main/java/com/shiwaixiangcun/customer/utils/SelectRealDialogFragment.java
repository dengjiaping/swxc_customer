 ...
 */
public class SelectRealDialogFragment extends DialogFragment implements WheelView.OnValueChangeListener {
     ...
     * @return
     */
    public static SelectRealDialogFragment newInstance(String[] wheel, String left, String right,
                                                          boolean isBack, boolean isCancelable, boolean isCancelableTouchOutSide) {
        SelectRealDialogFragment wheelDialog = new SelectRealDialogFragment();
     ...
     * @return
     */
    public static SelectRealDialogFragment newInstance(String[] wheel) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.select_real_dialog_wheel, null);
    ...
    private void setSubView() {
        ...
        wheelView.setDividerColor(ResUtil.getColor(R.color.ui_grad));
        wheelView.setSelectedTextColor(ResUtil.getColor(R.color.word_black));
        wheelView.setNormalTextColor(ResUtil.getColor(R.color.ui_green));
    }
