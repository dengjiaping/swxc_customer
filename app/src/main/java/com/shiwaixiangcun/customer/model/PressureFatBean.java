...
public class PressureFatBean implements Serializable {
    ...
    /**
     * data : {"elements":[{"createTime":1497592618000,"healthStatus":"NORMAL","id":147,"lowLipo":2.5,"lowLipoStatus":"NORMAL","source":null,"statusEnum":"Zhengchang","suggestion":"�뱣�ֵ�ǰ�Ľ������ʽ���ʵ���һЩ�����˶��������ܡ������г�������������ٵ�","topLipo":3.1,"topLipo1Status":"NORMAL","totalCholesterol":5,"totalCholesterolStatus":"NORMAL","triglyceride":1.5,"triglycerideStatus":"WARNING"}],"page":1,"size":7,"totalAmount":1,"totalPages":1}
     * message : �����ɹ�
     * responseCode : 1001
     * success : true
     */
    ...
    public static class DataBean implements Serializable {
        /**
         * elements : [{"createTime":1497592618000,"healthStatus":"NORMAL","id":147,"lowLipo":2.5,"lowLipoStatus":"NORMAL","source":null,"statusEnum":"Zhengchang","suggestion":"�뱣�ֵ�ǰ�Ľ������ʽ���ʵ���һЩ�����˶��������ܡ������г�������������ٵ�","topLipo":3.1,"topLipo1Status":"NORMAL","totalCholesterol":5,"totalCholesterolStatus":"NORMAL","triglyceride":1.5,"triglycerideStatus":"WARNING"}]
         * page : 1
         * size : 7
         * totalAmount : 1
         * totalPages : 1
        ...
        public static class ElementsBean implements Serializable{
             ...
             * suggestion : �뱣�ֵ�ǰ�Ľ������ʽ���ʵ���һЩ�����˶��������ܡ������г�������������ٵ�
             * topLipo : 3.1
